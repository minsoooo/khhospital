			...
			<div class="span10" style="margin-bottom: 60px; margin-top: 40px;">
				<table class="table">
					...
					<tr><td id="f_button" colspan="3">
						...
						<a href="/khhospital/control?cmd=QBOARDMAIN" class="btn">목록</a>&nbsp;&nbsp;
						<a href="javascript:fnDelete()" class="btn">삭제</a>						
					</td></tr>

					<form class="form-search" method="post" action="/khhospital/control">				
						<input type="hidden" name="cmd" value="QBOARDREPLYPROC" />
						...
						<jsp:include page="question_reply.jsp"></jsp:include>
			</div>
...
<form name="update" method="POST" action="/khhospital/control">
	<input type="hidden" name="cmd" value="QBOARDUPDATE"/>
	<input type="hidden" name="num" value="${rdto.num}"/>
	<input type="hidden" name="realpass" value="${rdto.pass}"/>
</form>

<form name="del" method="POST" action="/khhospital/control">
	<input type="hidden" name="cmd" value="QBOARDDELETE"/>
	<input type="hidden" name="num" value="${rdto.num}"/>
	<input type="hidden" name="realpass" value="${rdto.pass}"/>
</form>
<script src="/noniHospital/bootstrap/js/jquery-2.2.3.min.js"></script>
<script src="/noniHospital/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>