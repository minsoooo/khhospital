...
<div class="container">
	...
	<!-- 누른 글번호를 기준으로 DB에서 전송한 자료를 받아서 출력한다 -->
			...
			<div class="span10" style="margin-bottom: 60px; margin-top: 40px;">
				<table class="table">
					...
					<tr><td id="f_button" colspan="3">
						...
						<a href="/khhospital/control?cmd=ADBOARDMAIN" class="btn">목록</a>&nbsp;&nbsp;
						<a href="javascript:fnDelete()" class="btn">삭제</a>						
					</td></tr>
					
	<!-- 댓글을 입력하고 전송하는부분으로 현재 게시판의 글번호와 댓글내용 및 댓글을 다는 사람의 IP를 같이 전송한다. -->				

					<form class="form-search" method="post" action="/khhospital/control">				
						<input type="hidden" name="cmd" value="ADBOARDREPLYPROC" />
						...
						<jsp:include page="ad_reply.jsp"></jsp:include>
			</div>
