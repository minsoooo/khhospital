...
<div class="container">
		<div class="row">
			<div class="span8" style="margin-left: 15px">
				<a href="/khhospital/control?cmd=DEPTINDEX&dept=PSY"><img src="/khhospital/design/images/psy_logo.jpg" /></a>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="span12">
				<ul class="nav nav-tabs">
					<li class="span3" id="empty"><a href="/khhospital/control?cmd=PSYNBOARDMAIN">공지사항</a></li>
					<li class="span3"><a href="/khhospital/control?cmd=DOCINFOSEARCH&dept_no=6&where=psy">진료일정조회/예약</a></li>
					<li class="span3"><a href="/khhospital/control?cmd=PSYQBOARDMAIN">온라인질문</a></li>
				</ul>
			</div>		
		</div>
	</div>
