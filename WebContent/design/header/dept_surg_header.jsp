...
<div class="container">
		<div class="row">
			<div class="span8" style="margin-left: 15px">
				<a href="/khhospital/control?cmd=DEPTINDEX&dept=SURG"><img src="/khhospital/design/images/surgery_logo.jpg" /></a>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="span12">
				<ul class="nav nav-tabs">
					<li class="span3" id="empty"><a href="/khhospital/control?cmd=SURGNBOARDMAIN">공지사항</a></li>
					<li class="span3"><a href="/khhospital/control?cmd=DOCINFOSEARCH&dept_no=1&where=surg">진료일정조회/예약</a></li>
					<li class="span3"><a href="/khhospital/control?cmd=SURGQBOARDMAIN">온라인질문</a></li>
				</ul>
			</div>		
		</div>
	</div>
