...
public class DocDentQBoardReadCommand implements Command {
	...
	public DocDentQBoardReadCommand(){
		try{			
			pool = dbcp.DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocDentQBoardReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocDentQBoardReadCommand : " + e);
		}
		finally{
		...
		return "/design/doctor/dent/doc_dent_question_read.jsp";
