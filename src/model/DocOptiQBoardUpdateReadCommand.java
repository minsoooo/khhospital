...
public class DocOptiQBoardUpdateReadCommand implements Command {
	...
	public DocOptiQBoardUpdateReadCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocOptiQBoardUpdateReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		if(userpass.equals(realpass)){
			...
			try {
				...
				System.out.println("DocOptiQBoardUpdateReadCommand : " + e);
			}
			finally{
			...
			url = "/design/doctor/opti/doc_opti_question_update_proc.jsp";
		}
		
		else{
			url = "/control?cmd=DOCOPTIQBOARDERROR&num="+num;
		}		
