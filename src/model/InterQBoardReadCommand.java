...
public class InterQBoardReadCommand implements Command {
	...
	public InterQBoardReadCommand(){
		try{			
			pool = dbcp.DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("InterQBoardReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("InterQBoardReadCommand : " + e);
		}
		finally{
		...
		return "/design/dept/internal/inter_question_read.jsp";
