...
public class DocOptiQBoardReplyProcCommand implements Command {
	...
	public DocOptiQBoardReplyProcCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocOptiQBoardReplyProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocOptiQBoardReplyProcCommand : " + e);
		}
		finally{
