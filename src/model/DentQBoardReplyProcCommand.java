...
public class DentQBoardReplyProcCommand implements Command {
	...
	public DentQBoardReplyProcCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DentQBoardReplyProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DentQBoardReplyProcCommand : " + e);
		}
		finally{
