...
public class DocOptiQBoardReadCommand implements Command {
	...
	public DocOptiQBoardReadCommand(){
		try{			
			pool = dbcp.DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocOptiQBoardReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocOptiQBoardReadCommand : " + e);
		}
		finally{
		...
		return "/design/doctor/opti/doc_opti_question_read.jsp";
