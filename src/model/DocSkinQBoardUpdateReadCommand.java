...
public class DocSkinQBoardUpdateReadCommand implements Command {
	...
	public DocSkinQBoardUpdateReadCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocSkinQBoardUpdateReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		if(userpass.equals(realpass)){
			...
			try {
				...
				System.out.println("DocSkinQBoardUpdateReadCommand : " + e);
			}
			finally{
			...
			url = "/design/doctor/skin/doc_skin_question_update_proc.jsp";
		}
