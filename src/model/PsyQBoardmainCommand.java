...
public class PsyQBoardmainCommand implements Command {
	...
	public PsyQBoardmainCommand(){
		try {
			pool = DBConnectionMgr.getInstance();
		} catch (Exception err) {
			System.out.println("PsyQBoardmainCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("PsyQBoardmainCommand : " + e);
		}
		finally{
		...
		return "/design/dept/psy/psy_question_board.jsp";
	}
