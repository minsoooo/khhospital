...
public class MgrOQBoardUpdateCommand implements Command {
	...
	public  MgrOQBoardUpdateCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("MgrOQBoardUpdateCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("MgrOQBoardUpdateCommand : " + e);
		}
		finally{
		...
		return "/design/mgr/mgr_oq_update_proc.jsp";
	}
}
