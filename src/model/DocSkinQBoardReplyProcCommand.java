...
public class DocSkinQBoardReplyProcCommand implements Command {
	...
	public DocSkinQBoardReplyProcCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocSkinQBoardReplyProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocSkinQBoardReplyProcCommand : " + e);
		}
		finally{
