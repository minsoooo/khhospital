...
public class SurgQBoardReplyProcCommand implements Command {
	...
	public SurgQBoardReplyProcCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("SurgQBoardReplyProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("SurgQBoardReplyProcCommand : " + e);
		}
		finally{
