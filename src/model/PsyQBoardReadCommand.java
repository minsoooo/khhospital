...
public class PsyQBoardReadCommand implements Command {
	...
	public PsyQBoardReadCommand(){
		try{			
			pool = dbcp.DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("PsyQBoardReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("PsyQBoardReadCommand : " + e);
		}
		finally{
		...
		return "/design/dept/psy/psy_question_read.jsp";
