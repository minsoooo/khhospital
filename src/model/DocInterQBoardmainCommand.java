...
public class DocInterQBoardmainCommand implements Command {
	...
	public DocInterQBoardmainCommand(){
		try {
			pool = DBConnectionMgr.getInstance();
		} catch (Exception err) {
			System.out.println("DocInterQBoardmainCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		return "/design/doctor/internal/doc_inter_question_board.jsp";
	}
