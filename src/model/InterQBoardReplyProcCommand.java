...
public class InterQBoardReplyProcCommand implements Command {
	...
	public InterQBoardReplyProcCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("InterQBoardReplyProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("InterQBoardReplyProcCommand : " + e);
		}
		finally{
