...
public class DocPsyQBoardReplyProcCommand implements Command {
	...
	public DocPsyQBoardReplyProcCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocPsyQBoardReplyProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocPsyQBoardReplyProcCommand : " + e);
		}
		finally{
