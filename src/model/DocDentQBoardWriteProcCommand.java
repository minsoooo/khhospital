...
public class DocDentQBoardWriteProcCommand implements Command {
	...
	public DocDentQBoardWriteProcCommand(){
		try{
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocDentQBoardWriteProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {			
			...
			System.out.println("DocDentQBoardWriteProcCommand : " + e);
		}
		finally{
	    	  pool.freeConnection(con,stmt);
		}		
		
		return "/control?cmd=DOCDENTQBOARDMAIN";
