...
public class PsyQBoardUpdateReadCommand implements Command {
	...
	public PsyQBoardUpdateReadCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("PsyQBoardUpdateReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		if(userpass.equals(realpass)){
			...
			try {
				...
				System.out.println("PsyQBoardUpdateReadCommand : " + e);
			}
			finally{
			...
			url = "/design/dept/psy/psy_question_update_proc.jsp";
		}
