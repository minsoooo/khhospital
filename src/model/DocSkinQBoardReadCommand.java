...
public class DocSkinQBoardReadCommand implements Command {
	...
	public DocSkinQBoardReadCommand(){
		try{			
			pool = dbcp.DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocSkinQBoardReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocSkinQBoardReadCommand : " + e);
		}
		finally{
		...
		return "/design/doctor/skin/doc_skin_question_read.jsp";
