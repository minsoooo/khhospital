...
public class DocInterQBoardUpdateReadCommand implements Command {
	...
	public DocInterQBoardUpdateReadCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocInterQBoardUpdateReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		if(userpass.equals(realpass)){
			...
			try {
				...
				System.out.println("DocInterQBoardUpdateReadCommand : " + e);
			}
			finally{
			...
			url = "/design/doctor/internal/doc_inter_question_update_proc.jsp";
		}
