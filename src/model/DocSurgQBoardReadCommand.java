...
public class DocSurgQBoardReadCommand implements Command {
	...
	public DocSurgQBoardReadCommand(){
		try{			
			pool = dbcp.DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocSurgQBoardReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocSurgQBoardReadCommand : " + e);
		}
		finally{
		...
		return "/design/doctor/surgery/doc_surg_question_read.jsp";
