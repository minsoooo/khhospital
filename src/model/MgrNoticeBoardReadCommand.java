...
public class MgrNoticeBoardReadCommand implements Command {
	...
	public MgrNoticeBoardReadCommand(){
		try{			
			pool = dbcp.DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("MgrNoticeBoardReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			if(isRead.equals("true")){	
				String upSql = "update NBoard_main set nb_count_main=nb_count_main+1 where nb_num_main=" + num;
			...
			System.out.println("MgrNoticeBoardReadCommand : " + e);
		}
		finally{
		...
		if(mgr == null){
			mgr = "false";
			url = "/design/board/notice_read.jsp";
		}
		else{
			if(mgr.equals("true")){
				url = "/design/mgr/mgr_notice_read.jsp";
			}		
		}
