...
public class DocInterQBoardWriteProcCommand implements Command {
	...
	public DocInterQBoardWriteProcCommand(){
		try{
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocInterQBoardWriteProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {			
			...
			System.out.println("DocInterQBoardWriteProcCommand : " + e);
		}
		finally{
	    	  pool.freeConnection(con,stmt);
		}	
	
		return "/control?cmd=DOCINTERQBOARDMAIN&nowPage=0&nowBlock=0";
