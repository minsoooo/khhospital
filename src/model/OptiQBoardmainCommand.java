...
public class OptiQBoardmainCommand implements Command {
	...
	public OptiQBoardmainCommand(){
		try {
			pool = DBConnectionMgr.getInstance();
		} catch (Exception err) {
			System.out.println("OptiQBoardmainCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("OptiQBoardmainCommand : " + e);
		}
		finally{
		...
		return "/design/dept/opti/opti_question_board.jsp";
	}
