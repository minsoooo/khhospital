...
public class DocSkinQBoardmainCommand implements Command {
	...
	public DocSkinQBoardmainCommand(){
		try {
			pool = DBConnectionMgr.getInstance();
		} catch (Exception err) {
			System.out.println("DocSkinQBoardmainCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DocSkinQBoardmainCommand : " + e);
		}
		finally{
		...
		return "/design/doctor/skin/doc_skin_question_board.jsp";
	}
