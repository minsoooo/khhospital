...
public class DocSurgQBoardUpdateReadCommand implements Command {
	...
	public DocSurgQBoardUpdateReadCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocSurgQBoardUpdateReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		if(userpass.equals(realpass)){
			...
			try {
				...
				System.out.println("DocSurgQBoardUpdateReadCommand : " + e);
			}
			finally{
			...
			url = "/design/dept/surgery/doc_surg_question_update_proc.jsp";
		}
		
		else{
			url = "/control?cmd=DOCSURGQBOARDERROR&num="+num;
		}		
