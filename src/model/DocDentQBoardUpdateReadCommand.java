...
public class DocDentQBoardUpdateReadCommand implements Command {
	...
	public DocDentQBoardUpdateReadCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocDentQBoardUpdateReadCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		if(userpass.equals(realpass)){
			...
			try {
				...
				System.out.println("DocDentQBoardUpdateReadCommand : " + e);
			}
			finally{
			...
			url = "/design/doctor/dent/doc_dent_question_update_proc.jsp";
		}
