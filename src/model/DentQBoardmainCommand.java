...
public class DentQBoardmainCommand implements Command {
	...
	public DentQBoardmainCommand(){
		try {
			pool = DBConnectionMgr.getInstance();
		} catch (Exception err) {
			System.out.println("DentQBoardmainCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("DentQBoardmainCommand : " + e);
		}
		finally{
		...
		return "/design/dept/dent/dent_question_board.jsp";
	}
