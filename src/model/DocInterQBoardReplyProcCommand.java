...
public class DocInterQBoardReplyProcCommand implements Command {
	...
	public DocInterQBoardReplyProcCommand(){
		try{			
			pool = DBConnectionMgr.getInstance();
		}
		catch(Exception err){
			System.out.println("DocInterQBoardReplyProcCommand : " + err);
		}
	}
	...
	public Object processCommand(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			String sql = "insert into QBoard_inter_Reply(qb_replyregdate_inter,qb_replyip_inter,qb_replyid_inter,qb_replypass_inter,"
					+ "qb_replycontent_inter,qb_num_inter) values(now(),?,?,?,?,?)";
			...
			System.out.println("DocInterQBoardReplyProcCommand : " + e);
		}
		finally{
